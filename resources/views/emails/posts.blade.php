...
<div>
    <table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation'
           style='background:#30373b;background-color:#30373b;width:100%;'>
        <tbody>
        <tr>
            <td>
                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="vertical-align:top;width:360px;">
                                            <div class='dys-column-per-60 outlook-group-fix'
                                                    ...
                                                    <tr>
                                                        <td align='left'
                                                            ...
                                                            <div
                                                                ...
                                                                Post "{{$post->title}}" was successfully created
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
                                        ...
                                        <td style="vertical-align:top;width:240px;">
                                            <div class='dys-column-per-40 outlook-group-fix'
                                                 style='direction:ltr;display:inline-block;font-size:13px;text-align:left;vertical-align:top;width:100%;'>
                                                <table border='0' cellpadding='0' cellspacing='0' role='presentation'
                                                       style='vertical-align:top;' width='100%'>
                                                    <tr>
                                                        <td align='right'
                                                            style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                                            <div
                                                                style='color:#848789;font-family:Open Sans, Arial, sans-serif;font-size:12px;line-height:18px;text-align:right;text-decoration:none;'>
                                                                <a href='#'
                                                                   style='text-decoration:underline; color:#848789;'
                                                                   target='_blank'>
                                                                    View Online
                                                                </a>
                                                            </div>
                                                            ...
                                                            <table border='0' cellpadding='0' cellspacing='0'
                                                                ...
                                                                <tr>
                                                                    <td style='width:333px;'>
                                                                        <img alt='Congratulations!' height='303'
                                                                             src='https://sun9-38.userapi.com/c836624/v836624754/d334/WwMpU_UXqmw.jpg'
                                                                             style='border:0;display:block;font-size:13px;height:303px;outline:none;text-decoration:none;width:100%;'
                                                                             width='333'/>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="vertical-align:top;width:600px;">
                                                            ...
                                                            <table border='0' cellpadding='0' cellspacing='0'
                                                                ...
                                                                <tr>
                                                                    <td align='center'
                                                                        ...
                                                                        <div
                                                                            style='color:#848789;font-family:Open Sans, Arial, sans-serif;font-size:12px;line-height:18px;text-align:center;text-transform:uppercase;'>
                                                                            <a href='# Privacy'
                                                                               style='text-decoration:underline; color:#848789;'
                                                                               target='_blank'>
                                                                                PRIVACY STATEMENT
                                            ...
                                            <a href='#' style='text-decoration:underline; color:#848789;'
                                               target='_blank'>
                                              unsubscribe
                                            </a>
                                          </span>
