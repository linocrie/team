                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="es-infoblock esd-block-text es-m-txt-c" align="left">
                                                                <p style="font-family: arial, helvetica\ neue, helvetica, sans-serif;">Success<br></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td align="center" class="esd-block-text es-p40t es-p10b">
                                                                <h1 style="color: #ffffff;">Gallery {{$gallery->title}} was successfully created</h1>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td esdev-links-color="#757575" class="esd-block-text es-p10t es-p20b es-p30r es-p30l" align="center">
                                                                <p style="color: whitesmoke;">We are happy for your visit  </p>
                                                                <p style="color: whitesmoke;">You have {{$gallery->images->count()}} images in {{$gallery->title}} gallery</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-button es-p10t es-p20b" align="center"><span class="es-button-border" style="border-width: 0px; border-style: solid; background: none 0% 0% repeat scroll #26a4d3; border-color: #26a4d3;"><a href="http://127.0.0.1:8000/" class="es-button" target="_blank" style="background: #26a4d3 none repeat scroll 0% 0%; border-color: #26a4d3;">Go Instagram Clone</a></span></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
